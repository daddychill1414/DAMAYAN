...
export const MagneticButton = ({ children, className = '', ...props }) => {
  return (
    <button 
      ...
      {...props}
    >
      <span className="absolute inset-0 w-full h-full bg-accent/10 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out z-0"></span>
